  ...
  theme: {
    extend: {
      ...
      spacing: {
        ...
        "ui-sidebar-dynamic": "var(--sidebar-width, var(--workspace-sidebar-width))",
        "ui-sidebar-min": "var(--workspace-sidebar-min-width)",
        "ui-sidebar-max": "var(--workspace-sidebar-max-width)",
